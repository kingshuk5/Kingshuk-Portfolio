    ...
    <>
      ...
      >
        ...
        Node.js. I’ve developed features like live cricket scores and dynamic web pages
         ...
         <div className='mt-8 border-l border-green-500'>
         <aside class="bg-gray-900 text-white p-6 rounded-lg w-full max-w-lg font-mono">
            ...
            <div class="mt-4">
              <div className='flex-row flex justify-between'>
                <div>
                  <p class="text-green-400">$LinkedIN</p>
                  <p class="text-white">Kingshuk Hazra</p>
                </div>
                  <a href="https://www.linkedin.com/in/kingshuk-hazra-b5497121b/" target="_blank" rel="noopener noreferrer">
                  <button class="bg-slate-950 text-slate-400 border border-slate-400 m-2 border-b-4 font-medium overflow-hidden relative  rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group">
              ...
              <div className='flex-row flex mt-2 justify-between'>
                <div>
                  ...
                  <p class="text-white">kingshuk5</p>
                </div>
                  <a href="https://github.com/kingshuk5" target="_blank" rel="noopener noreferrer">
                  <button class="bg-slate-950 text-slate-400 border border-slate-400 m-2 border-b-4 font-medium overflow-hidden relative  rounded-md hover:brightness-150 hover:border-t-4 hover:border-b active:opacity-75 outline-none duration-300 group">
              ...
              <p class="text-white">kingshukhazra5@gmail.com</p>
            </div>
          </aside>
         </div>
         <DownloadCVButton/>
